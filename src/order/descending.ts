 ...
 */
export function thenByDescending<T, TReturn = any>(key: Key<T, TReturn>): OrderedOperation<T> {
 ...
 */
export function orderByDescending<T, TKey = any>(key: Key<T, TKey>): OrderedEnumerable<T> {
